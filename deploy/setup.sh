...
echo "  3. Tag this device: create an auth key with tag:jit-access-app at tailscale.com/admin/settings/keys"
echo "     then run: sudo tailscale up --auth-key=<your-tagged-auth-key>"
echo "     Or tag it via Admin UI: tailscale.com/admin/machines > three-dot menu > Edit tags"
